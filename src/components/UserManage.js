...
import {
    ...
    UserManageSpan,
    UserManageButton,
    UserManagePrevButton,
    UserManageNextButton,
    UserManageH3,
    UserManageDescription,
    UserManageContainer,
    UserManageDiv
} from "../styles/styledUserManage";
//react Hooks기능 사용.
...
const UserManage = () => {
    ...
    return (
        <UserManageContainer>
            <UserManageDiv>
                <UserManageH3>회원관리 </UserManageH3>
                <UserManageDescription>아이온커뮤니케이션즈의 회원 정보를 안내해 드립니다.</UserManageDescription>

                <div id="realgrid"></div>
                <UserManageButton onClick={userAdd}>
                    추가
                </UserManageButton>
                <Toolbar>
                    <UserManagePrevButton onClick={setPrevPage}>
                        이전페이지
                    </UserManagePrevButton>
                    <UserManageSpan id="current-page-view"></UserManageSpan>
                    /
                    <UserManageSpan id="total-page-view"></UserManageSpan>
                    <UserManageNextButton onClick={setNextPage}>
                        다음페이지
                    </UserManageNextButton>
                </Toolbar>
